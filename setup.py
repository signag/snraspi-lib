...
setup(
    ...
    description="Convenience utilities for Raspberry Pi",  # Optional
    ...
    url="https://github.com/signag/snraspi-lib",  # Optional
    ...
    keywords="Raspberry Pi sensors",  # Optional
